  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end">
        <DropdownMenuItem onClick={() => openExternal("https://docs.voicelab.uz")}>
        ...
        <DropdownMenuItem
          onClick={async () => {
            const result = await window.electronAPI?.openExternal("mailto:info@voicelab.uz");
            if (!result?.success) {
              openExternal("https://mail.google.com/mail/?view=cm&to=info@voicelab.uz");
            }
          }}
        >
        ...
        <DropdownMenuItem
          onClick={() => openExternal("https://github.com/voicelab-uz/desktop/issues")}
        >
