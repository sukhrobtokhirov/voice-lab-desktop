...
final class AudioTapCapture {
    ...
    private let ioQueue = DispatchQueue(label: "uz.voicelab.desktop.audio-tap")
    ...
    func start() throws {
        ...
        tapDescription.name = "VoiceLab Audio Tap"
    ...
    private func createAggregateDevice(tapUID: String) throws {
        let description: [String: Any] = [
            kAudioAggregateDeviceNameKey: "VoiceLab Audio Tap",
            kAudioAggregateDeviceUIDKey: "uz.voicelab.desktop.audio-tap.\(UUID().uuidString)",
...
func makeError(
    ...
    return NSError(domain: "VoiceLabAudioTap", code: Int(status ?? -1), userInfo: userInfo)
}
