...
const preloadCapabilities = new Set(["acquireRecordingLock","addAgentMessage","agentOpenNote","agentWebSearch","attachSpeakerEmail","authCancelBrowser","authGetStatus","authReopenBrowser","cancelCloudTranscribe","cancelDiarizationDownload","cancelLlamaVulkanDownload","cancelUrlDownload","captureTargetPid","checkAccessibilityPermission","checkAccessibilityTrusted","checkLocalReasoningAvailable","checkMicrophoneAccess","checkPasteTools","checkSystemAudioAccess","cloudBillingPortal","cloudCheckout","cloudHealthCheck","cloudPreviewSwitch","cloudReason","cloudStreamingUsage","cloudSwitchPlan","cloudTranscribe","completeDictationPreview","deleteTempFile","desktopSyncBootstrap","desktopSyncPause","desktopSyncRun","desktopSyncSetPreferences","detectGpu","detectVulkanGpu","diarizeAudioFile","dismissDictationPreview","downloadUrlAudio","exportDictionary","exportNote","exportTranscript","getAction","getActions","getActivationMode","getActiveDictationKey","getAgentKey","getAgentMessages","getAgentWindowBounds","getAppVersion","getAudioBuffer","getAudioPath","getAudioStorageUsage","getAutoStartEnabled","getConversationsForNote","getDebugState","getDiarizationModelStatus","getDictationKey","getDictionary","getDictionaryState","getEffectiveDefaultHotkey","getFileSize","getFolderNoteCounts","getFolders","getGpuDeviceIndex","getHotkeyModeInfo","getHyprlandConfigStatus","getLlamaVulkanStatus","getLogLevel","getMD5Hash","getNote","getNoteRecordingConfig","getNotes","getOAuthProtocol","getOAuthProtocolRegistered","getPathForFile","getPendingMeetingNoteNavigation","getPendingNoteNavigation","getPlatform","getPostMigrationState","getRecordingIslandSupport","getReferralInvites","getReferralStats","getSnippets","getSpeakerMappings","getSpeakerProfiles","getSttConfig","getTranscriptionById","getTranscriptions","getTranslationKey","getUiLanguage","getVoiceAgentKey","getWhisperVadConfig","getYdotoolStatus","hideAgentOverlay","hideDictationPreview","hideWindow","listGpus","llamaCppCheck","llamaGpuReset","llamaServerStart","llamaServerStatus","llamaServerStop","log","markBundleMigrated","markBundleMigrationDismissed","meetingDetectionGetPreferences","meetingDetectionSetPreferences","meetingTranscriptionCancel","meetingTranscriptionPrepare","meetingTranscriptionSend","meetingTranscriptionSetSystemAudioEnabled","meetingTranscriptionStart","meetingTranscriptionStop","mergeSpeakerText","modelCheck","modelCheckRuntime","modelGetAll","noteFilesGetDefaultPath","notifyActivationModeChanged","notifyFloatingIconAutoHideChanged","notifyHotkeyChanged","notifyLimitReached","notifyPanelStartPositionChanged","notifyStartMinimizedChanged","onAccessibilityMissing","onActionCreated","onActionDeleted","onActionUpdated","onAgentStartRecording","onAgentStopRecording","onAgentStreamChunk","onAgentStreamEnd","onAgentStreamError","onAgentToggleRecording","onAuthStateChanged","onCancelHotkeyPressed","onCorrectionsLearned","onDesktopProtocolError","onDesktopUsageRefresh","onDiarizationDownloadProgress","onDictationKeyActive","onDictionaryUpdated","onFloatingIconAutoHideChanged","onGcalConnectionChanged","onGcalEventsSynced","onGlobeKeyPressed","onGlobeKeyReleased","onHotkeyFallbackUsed","onHotkeyRegistrationFailed","onLimitReached","onLinuxPttPermissionDenied","onLlamaVulkanDownloadProgress","onMeetingDiarizationComplete","onMeetingNoteNavigationPending","onMeetingSpeakerIdentified","onMeetingSpeakersMerged","onMeetingTranscriptionError","onMeetingTranscriptionSegment","onModelDownloadProgress","onNoAudioDetected","onNoteAdded","onNoteDeleted","onNoteNavigationPending","onNoteUpdated","onProviderStreamPart","onSemanticReindexProgress","onSettingUpdated","onShowSettings","onSnippetsUpdated","onStartDictation","onStopDictation","onToggleDictation","onToggleTranslation","onToggleVoiceAgent","onTranscriptionAdded","onTranscriptionDeleted","onTranscriptionUpdated","onTranscriptionsCleared","onUpdateAvailable","onUpdateDownloadProgress","onUpdateDownloaded","onUpdateError","onUpdateNotAvailable","onUploadTranscriptionProgress","onUrlDownloadProgress","onWindowsPushToTalkUnavailable","onWorkspaceInvitationToken","openAccessibilitySettings","openExternal","openLogsFolder","openMicrophoneSettings","openModelCacheFolder","openSoundInputSettings","openSystemAudioSettings","openVoiceLabBilling","pasteText","pauseMediaPlayback","processLocalReasoning","promptAccessibilityPermission","providerCredentialStatus","providerReason","providerStreamCancel","providerStreamStart","quitApp","readClipboard","registerCancelHotkey","registerMeetingHotkey","releaseRecordingLock","removeSpeakerMapping","requestMicrophoneAccess","requestSystemAudioAccess","resizeAgentWindow","resizeMainWindow","restoreFromMeetingMode","resumeMediaPlayback","retryTranscription","saveActivationMode","saveAgentKey","saveDictationKey","saveNoteSpeakerEmbeddings","saveTranscription","saveTranscriptionAudio","saveUiLanguage","saveWavRecording","searchContacts","searchNotes","selectAudioFile","semanticSearchConversations","semanticSearchNotes","sendReferralInvite","setAgentWindowBounds","setAutoLearnEnabled","setDebugLogging","setGpuDeviceIndex","setHotkeyListeningMode","setMainWindowInteractivity","setMeetingSessionSpeakerConfig","setNotificationInteractivity","setSnippets","setSpeakerDiarizationEnabled","setSpeakerMapping","setUiLanguage","setWhisperVadConfig","showAudioInFolder","showDictationPanel","showFolderInExplorer","showNoteFile","snapToMeetingMode","startAgentStream","startWindowDrag","stopDictationPreview","stopWindowDrag","syncNotificationPreferences","syncStartupPreferences","toggleAgentOverlay","toggleMediaPlayback","transcribeAudioFileCloud","undoLearnedCorrections","unregisterCancelHotkey","updateAgentHotkey","updateHotkey","updateTranscriptionText","updateTranslationHotkey","updateVoiceAgentHotkey","upsertContact","windowClose","windowIsMaximized","windowMaximize","windowMinimize","writeClipboard"]);
